...
plt.ylabel('累计概率')
plt.title('(b)',y=-0.20)
y1,=plt.plot(np.linspace(0,20,160),generate11,color='blue')
y3,=plt.plot(np.linspace(0,20,160),generate13,color='green')
y33,=plt.plot(np.linspace(0,20,160),generate14,color='purple')
y35,=plt.plot(np.linspace(0,20,160),generate15,color='black')
y2,=plt.plot(np.linspace(0,20,160),generate12,color='red')
y22,=plt.plot(np.linspace(0,20,160),generate122,color='orange')
