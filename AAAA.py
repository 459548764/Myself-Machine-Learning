...
dataq = [-70,-68,-65,-65,-71,-64,-64,-68,-69,-65,-71,-71,-69,-60,-66,-68,-69,-65,-66,-70,-64,-70,-70,-69]
...
plt.sca(ax1)
plt.grid()
plt.hist(data1, group1,normed=1, alpha=0.7,label='Aug 10')
rects2 = plt.hist(dataq, groupq,normed=1, alpha=0.7,label='Aug 20')
plt.xlabel('RSSI/dB')
...
plt.sca(ax2)
plt.grid()
rects1 = plt.hist(data1, group1,normed=1, alpha=0.7,label='Aug 10')
rects2 = plt.hist(data2, group2,normed=1, alpha=0.7,label='Aug 30')
plt.xlabel('RSSI/dB')
plt.ylabel('Probability')
plt.title('(b)',y=-0.17)
plt.legend()
