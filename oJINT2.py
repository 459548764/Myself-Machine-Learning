...
base2 = np.array([0,0.405,0.879,0.949,0.979,0.988,0.9999,0.9999,0.9999])
...
l6, = plt.plot(np.linspace(0,20,160),generate199,color='orange')
l7, = plt.plot(np.linspace(0,20,160),generate189,color='black')
